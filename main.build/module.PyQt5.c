...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "PyQt5", 33);
...
void checkModuleConstants_PyQt5(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "PyQt5", 33);
}
#endif
    ...
    // Framed code:
    {
        ...
        frame_a40c3c1135d7fbaaeabdfd0ba12ce566->m_frame.f_lineno = 1;
        {
            ...
            if (likely(hard_module != NULL)) {
                tmp_expression_name_1 = PyObject_GetAttr(hard_module, mod_consts[1]);
            } else {
        ...
        tmp_assign_source_3 = PyList_New(2);
        {
            ...
            frame_a40c3c1135d7fbaaeabdfd0ba12ce566->m_frame.f_lineno = 1;
            tmp_list_element_1 = CALL_METHOD_WITH_ARGS2(tmp_called_instance_1, mod_consts[17], &PyTuple_GET_ITEM(mod_consts[18], 0));
